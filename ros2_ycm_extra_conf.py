...
BASE_FLAGS = [
    ...
    '-std=c++20',
    '-x', 'c++',
    # system inlucde path, generated by `g++ -E -x c++ - -v`
    ...
    '-isystem', '/usr/include',
    #'-isystem', '/opt/ros/rolling/include/rcl',
    #'-isystem', '/opt/ros/rolling/include/rcutils',
    #'-isystem', '/opt/ros/rolling/include/rclcpp',
...
def GetDefaultRosIncludePaths():
    ...
    # ROS 2
        ...
        for package_name in get_package_names():
            include_path = os.path.join(get_package_prefix(package_name), 'include', package_name)
...
def Settings( **kwargs):
    ...
    if os.path.exists(database_dir):
        ...
        if database:
            ...
            if not compilation_info:
                final_flags = GetDefaultFlags()  # Use default flags if there are any loading error.
            else:
    ...
    if not final_flags:
        final_flags = GetDefaultFlags()  # Use default flags if there is no flags defined.
